 ...
 */
public class ChannelComment extends BaseActivity {

    //频道-点击后进入各个子频道-详情信息-评论
    ...
    public int setLayout() {
        return R.layout.activity_channel_comment;
    }

    @Override
    protected void initView() {

        expandableListView = (ExpandableListView) findViewById(R.id.channel_comment_elv);
        totalNumTv = (TextView) findViewById(R.id.channel_comment_total_num);
        returnImg = (ImageView) findViewById(R.id.channel_comment_returnImg);
    }
